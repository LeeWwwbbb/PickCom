...
<main>
    <div
        ...
        <form action="/my/pwChangeAction.do" method="post" name="pwChangeForm"
            ...
            <div>
                <button type="submit" class="btn btn-primary" id="joinBtn" style="width: 300px; float: right;">비밀번호 변경
                </button>
            </div>
        </form>
    </div>
