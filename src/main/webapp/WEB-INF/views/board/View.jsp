            ...
            <div class="container">
                <c:if test="${not empty map}">
                    ...
                    <table class="table mb-4">
                        ...
                        <tr>
                            <td colspan="4" height="300"><c:if test="${ not empty map.image_saveName }"><img
                                    src="/uploaded-files/${map.image_saveName}" alt="첨부 이미지"
                                    style="max-width: 400px; max-height: 500px"/><br></c:if>${ map.board_content }</td>
                        </tr>
                        <!-- 첨부파일 -->
                            <%--<tr>
                                <td>첨부파일</td>
