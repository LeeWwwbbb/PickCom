    ...
    <main>
        <c:if test="${not empty map}">
                ...
                <div class="row mb-4">
                    <div class="col-2">
                        <c:if
                                test="${ sessionScope.rank || map.member_nickName == sessionScope.name }">
                            <button type="button" class="btn btn-danger w-100"
                                    onclick="location.href='/board/deleteBoard.do&idx=${ map.board_num }';">
                                삭제하기
                            </button>
                        </c:if>
                    </div>
                        <%--<div class="col text-end">
                            <a href="/board/like/?idx=${ map.board_num }"> <c:if
                                    test="${ like }">
                    ...
                    <div class="col-2">
                        <c:if
                            ...
                            <button type="button" class="btn btn-success w-100"
                                    onclick="location.href='pass.do?mode=edit&idx=${ map.board_num }';">수정
                            </button>
                        </c:if>
                    </div>
                </div>
